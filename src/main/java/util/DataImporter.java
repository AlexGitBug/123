...
public class DataImporter {
    ...
    public void importData(SessionFactory sessionFactory) {
        ...
        addToShoppingCart(session, Instant.now(), orderIvan, apple13);
        addToShoppingCart(session, Instant.now().plusSeconds(20), orderSveta, apple14);
        addToShoppingCart(session, Instant.now().plusSeconds(10), orderPetr, samsungA80J);
        addToShoppingCart(session, Instant.now().plusSeconds(10), orderPetr, samsungS22);
    }
    private void addToShoppingCart(Session session, Instant instant, Order order, Product... products){
